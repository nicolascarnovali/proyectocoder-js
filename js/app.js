...
function mostrarCarrito() {
    ...
    if (carrito.length === 0) {
        ...
        for (let i = 0; i < carrito.length; i++) {
            ...
            if (producto.descuento) {
                let descuentoPorUnidad = producto.precio * 0.2;
                descuento = descuentoPorUnidad * producto.cantidad;
                productoPrecio.innerText = "Precio unitario: $" + producto.precio.toFixed(2) + " (Descuento: $" + descuento.toFixed(2) + ")";
                descuentoTotal += descuento;
            } else {
                productoPrecio.innerText = "Precio unitario: $" + producto.precio.toFixed(2);
            }
